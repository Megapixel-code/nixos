...

{
  ...
  networking.networkmanager.enable = true; # Disabled because we use impala pkg
  networking.wireless.iwd.enable = true; # needed for using impala network manager
  ...
  # enable OpenGl
  # required for most graphical apps
